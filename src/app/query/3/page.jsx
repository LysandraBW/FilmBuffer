                    ...
                    <div className={styles.info}>
                            <Info
                                ...
                                card={
                                    <Card
                                        header="Movie"
                                        infoLabels={["Runtime", "Rating", "Genre"]}
                                        data={activeTrend == null ? null : (groupedData ? chartData.cards[activeTrend[0]][activeTrend[1]]: [chartData.cards["Collab"][activeTrend[1]]])}
                                    />
                                }
                            />
                    </div>
